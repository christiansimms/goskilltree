...
var diffFilter = function arraysDiffFilter(context) {
  ...
  if (commonHead + commonTail === len1) {
    ...
    crsGlobal(context, result, 'array');
...
var diffFilter = function textsDiffFilter(context) {
  ...
  if (context.left.length < minLength ||
    ...
    crsGlobal(context, [context.left, context.right], 'string');
    context.setResult([context.left, context.right]).exit();
    return;
  }
...
var diffFilter = function trivialMatchesDiffFilter(context) {
  ...
  if (typeof context.left === 'undefined') {
    ...
    crsGlobal(context, [context.right], 'trivial');
    context.setResult([context.right]).exit();
    return;
  }
  if (typeof context.right === 'undefined') {
    crsGlobal(context, [context.left, 0, 0], 'trivial');
  ...
  if (context.leftType !== context.rightType) {
    crsGlobal(context, [context.left, context.right], 'trivial');
    context.setResult([context.left, context.right]).exit();
    return;
  }
  ...
  if (context.left instanceof RegExp) {
    if (context.right instanceof RegExp) {
      crsGlobal(context, [context.left.toString(), context.right.toString()], 'trivial');
